...
dataframe["Location"] = dataframe["Location"].replace(
    {1.0: "City Center", 0.0: "Airbnb listing"}
)

# Display dataframe and text
st.dataframe(dataframe)
st.markdown("Below is a map showing all the Airbnb listings with a red dot and city center with a blue dot.")
...
fig = px.scatter_mapbox(
    ...
    width=800,
    hover_name="Price",
    hover_data=["Meters from city center", "Location"],
